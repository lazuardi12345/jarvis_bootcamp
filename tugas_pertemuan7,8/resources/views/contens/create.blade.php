    ...
    <div class="col-12">
        <form method="post" action="/users">
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" value="{{old('email')}}" placeholder="Email Adddress" class="form-control @error ('email') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
             @error('email')
